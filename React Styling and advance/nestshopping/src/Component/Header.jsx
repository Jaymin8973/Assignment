          ...
          <div className="col-xl-3 col-lg-4">
            <div className="header-info header-info-right">
              <ul>
                ...
                <li>
                  <a className="language-dropdown-active" href="#"><i className="fi-rs-angle-small-down" /> English</a>
                ...
                <li>
                  <a className="language-dropdown-active" href="#"><i className="fi-rs-angle-small-down" /> USD</a>
                  <ul className="language-dropdown">
                    <li>
        ...
        <div className="header-wrap header-space-between position-relative">
          ...
          <div className="header-nav d-none d-lg-flex">
            ...
            <div className="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
              <nav>
                <ul>
                  <li className="hot-deals"><img src="assets/imgs/theme/icons/icon-hot.svg" alt="hot deals" /><a href="shop-grid-right.html">Hot Deals</a></li>
                  <li>
